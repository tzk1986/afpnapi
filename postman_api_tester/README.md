...
本版新增重点（v1.30.66）：
- **开发阅读文档走查精简**：852 行压缩至 524 行（-38%）；2.2 目录结构同步实际代码（handlers 18 文件 / services 26 文件 / utils 21 文件 / templates 15 页面全部列出）
- **修正过时内容**：测试总数 1217 → ~2100；report_server.py 路由数 33 → 38；第 6 章"约束更新记录"从流水账压缩为关键里程碑
