...
- **Collection 编辑器快捷键体系**：11 项键盘快捷键（Ctrl+S/D/N/F/1~6/Enter/Shift+I、F2、Delete、Esc、Ctrl+↑↓），含快捷键帮助面板
- **竞品调研文档**：`竞品调研参考.md`，覆盖 Bruno、Hoppscotch、Schemathesis、Tavern、HTTPie 的功能对比与借鉴要点

### 版本说明

- v1.20.13（快捷键 + 竞品调研）因分支命名差异未被 08:30 自动合并流程发现，本次手动补合并
- v1.20.14（WCAG 无障碍 + 异常诊断 + 配置规范化）已于今早合并
- 统一版本号至 v1.20.15，包含 v1.20.13 + v1.20.14 全部内容

### 验证结果

- pytest: 1986 passed
- mypy: 无问题
- 合并无冲突（v1.20.13 仅新增文件和代码，未修改版本号）
