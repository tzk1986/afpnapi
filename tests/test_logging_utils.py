    ...
    def test_emit_tracks_by_level(self) -> None:
        ...
        handler.emit(
            logging.makeLogRecord(
                {"msg": "a", "levelname": "INFO", "levelno": logging.INFO, "name": "t"}
            )
        )
        handler.emit(
            logging.makeLogRecord(
...
class TestConfigureLoggingFileHandler:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            try:
                ...
                matching = [
                    ...
                    and getattr(h, "baseFilename", "") == expected_path
                ]
                assert (
                    len(matching) >= 1
                ), f"未找到 log_file={expected_path} 的 RotatingFileHandler"
            finally:
    ...
    def test_log_file_empty_does_not_add_handler(self) -> None:
        ...
        try:
            ...
            original_file = [
                h for h in original_handlers if isinstance(h, RotatingFileHandler)
            ]
